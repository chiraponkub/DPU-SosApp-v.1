...
import (
	...
	"github.com/chiraponkub/DPU-SosApp-v.1.git/restapi/structure"
...
type FactoryInterface interface {
	...
	GetRoleDB(req structure.Role) (response structure.Role, Error error)
...
func (ctrl Controller) Test(c echo.Context) error {
